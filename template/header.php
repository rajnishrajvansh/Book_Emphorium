...
<?php
// session_start();
$cartCount = isset($_SESSION['total_items']) ? $_SESSION['total_items'] : 0;
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top"  >
      <div class="container">
        <div class="navbar-header" >
          ...
          <div class="row" >
            <a class="navbar-brand" href="index.php" col-md-3>Book Emporium</a>
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
              ...
              (<span id="cart-count"><?php echo $cartCount; ?></span>)</a></li>
              <?php 
    ...
    <div class="jumbotron" style="  background: url('https://c0.wallpaperflare.com/preview/579/959/661/book-shelf-library-house.jpg') no-repeat center center;background-size: cover;height:400px
;
  " >
      <div class="container">
        <h1 style="text-align:center; margin:5% auto; color:white">BOOK EMPORIUM</h1>   
        <p style="text-align:center; margin:5% auto ; color:white ">Here you can find your favourite books and order them online!</p>     
      </div>
    </div>
    <?php } ?>
